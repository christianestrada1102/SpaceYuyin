...
public class Demo_FreeCam : MonoBehaviour
{
    ...
    [SerializeField, Tooltip("Arrastra tu cámara aquí. Si se deja vacío, se buscará automáticamente.")]
    private Camera cam;

    private void Awake()
    {
        // Obtener la cámara del componente o buscar la principal
    ...
    {
        // Verificar que tengamos una cámara
        if (cam == null)
            return;
